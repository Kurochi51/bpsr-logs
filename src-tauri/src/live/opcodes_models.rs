...
impl Encounter {
    pub  fn reset_stats(&mut self) {
        self.dmg_stats.value = 0;
        self.dmg_stats_boss_only.value = 0;
        self.heal_stats.value = 0;
        self.time_fight_start_ms = Default::default();
        self.entity_uid_to_entity.iter_mut().for_each(|(_, entity)| {
            // Damage
            entity.dmg_stats.value = 0;
            entity.dmg_stats.crit_value = 0;
            entity.dmg_stats.crit_hits = 0;
            entity.dmg_stats.lucky_value = 0;
            entity.dmg_stats.lucky_hits = 0;
            entity.dmg_stats.hits = 0;
            // Boss Damage
            entity.dmg_stats_boss_only.value = 0;
            entity.dmg_stats_boss_only.crit_value = 0;
            entity.dmg_stats_boss_only.crit_hits = 0;
            entity.dmg_stats_boss_only.lucky_value = 0;
            entity.dmg_stats_boss_only.lucky_hits = 0;
            entity.dmg_stats_boss_only.hits = 0;
            // Healing
            entity.heal_stats.value = 0;
            entity.heal_stats.crit_value = 0;
            entity.heal_stats.crit_hits = 0;
            entity.heal_stats.lucky_value = 0;
            entity.heal_stats.lucky_hits = 0;
            entity.heal_stats.hits = 0;
            // For Monsters
            entity.curr_hp = Some(0);
            entity.max_hp = Some(0);
            entity.monster_id = Some(0);
        })
    }
}
